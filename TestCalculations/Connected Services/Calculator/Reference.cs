...
namespace TestCalculations.Calculator {
    ...
    public interface CalculatorSoap {
        ...
        double Square(double f1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Square", ReplyAction="*")]
        System.Threading.Tasks.Task<double> SquareAsync(double f1);
    ...
    public partial class CalculatorSoapClient : System.ServiceModel.ClientBase<TestCalculations.Calculator.CalculatorSoap>, TestCalculations.Calculator.CalculatorSoap {
        ...
        public double Square(double f1) {
            return base.Channel.Square(f1);
        }
        
        public System.Threading.Tasks.Task<double> SquareAsync(double f1) {
            return base.Channel.SquareAsync(f1);
        }
